...
module_name = "cryomem.analysis.fit_datafile"
cmdlist = ["fit_datafile"]
target_class = None

from ..analysis import fit_datafile as target_module
_cmdlist = []
...
def main(argv):
    ...
    # If no command is specified above, take the 
    if len(_cmdlist) == 0:
        argv.insert(1, fit_datafile)
    cmd = argv[1]
    #target_instance = getattr(target_module, _target_class)()
    target_instance = target_module
